...
{
    public class TraceRepository : BaseSimpleRepository<eTeller.Domain.Models.Trace>, ITraceRepository
    {
        static TraceRepository()
        {
        ...
        public TraceRepository(eTellerDbContext dbContext) : base(dbContext)
        {
        }
