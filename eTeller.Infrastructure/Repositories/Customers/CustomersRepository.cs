...
{
    public class CustomersRepository : BaseSimpleRepository<Customers>, ICustomersRepository
    {
        public CustomersRepository(eTellerDbContext dbContext) : base(dbContext)
        {
        }
