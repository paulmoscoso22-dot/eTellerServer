...
{
    public class TotalicCassaRepository : BaseSimpleRepository<TotalicCassa>, ITotalicCassaRepository
    {
        static TotalicCassaRepository()
        {
        ...
        public TotalicCassaRepository(eTellerDbContext dbContext) : base(dbContext)
        {
        }
