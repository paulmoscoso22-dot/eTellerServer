...
{
    public class TransactionMovRepository : BaseSimpleRepository<TransactionMov>, ITransactionMovRepository
    {
        public TransactionMovRepository(eTellerDbContext dbContext) : base(dbContext)
        {
        }
