...
{
    public class GetAccountsByAccIdQueryHandle : IRequestHandler<GetAccountsByAccIdQuery, IEnumerable<AccountVm>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public GetAccountsByAccIdQueryHandle(IUnitOfWork unitOfWork, IMapper mapper)
        {
