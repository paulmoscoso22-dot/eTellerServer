...
{
    public class GetAccountsByAccountIdAndTypeQueryHandler : IRequestHandler<GetAccountsByAccountIdAndTypeQuery, IEnumerable<AccountVm>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public GetAccountsByAccountIdAndTypeQueryHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
