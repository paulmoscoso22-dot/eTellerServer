...
{
    public class GetTransactionWithFiltersQueryHandler : IRequestHandler<GetSpTransactionWithFiltersQuery, IEnumerable<TransactionVm>>
    {
        ...
        public async Task<IEnumerable<TransactionVm>> Handle(GetSpTransactionWithFiltersQuery request, CancellationToken cancellationToken)
        {
            ...
            _logger.LogInformation("Handled {QueryName}, returned {Count} items", nameof(GetSpTransactionWithFiltersQuery), transactionVms?.Count() ?? 0);
