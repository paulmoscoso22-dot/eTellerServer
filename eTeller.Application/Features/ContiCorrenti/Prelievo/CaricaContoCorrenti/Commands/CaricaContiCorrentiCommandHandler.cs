...
//    private readonly IVigilanzaRepository   _vigilanzaRepository;
...
//        IVigilanzaRepository vigilanzaRepository,
//        IMapper mapper,
...
//            {
//                await _unitOfWork.VigilanzaRepository.SalvaAntiRecyclingAsync(
//                    command.UserId,
//                    command.CodiceCassa,
//                    transaction.TrxId,
...
//            await _unitOfWork.VigilanzaRepository.DeleteByTrxIdAsync(transaction.TrxId, ct);
//            await GeneraMovimentiContabiliAsync(command, transaction, importi, ct);

//            // Verifica finale (saldo sufficiente, etc.)
//            var verificaFinale = await _unitOfWork.TransazioneRepository
...
//        await _unitOfWork.TransactionMovRepository.InsertMovimentoAsync(
...
//        var contoCassa = await _unitOfWork.AccountRepository
...
//        {
//            var contoAggio = await _unitOfWork.AccountRepository
